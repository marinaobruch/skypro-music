...
import { nextTrack, togglePlayer } from '../../redux/store/playerSlice.js'
				...
				<S.BarContainer>
					<S.Bar>
						...
						<S.BarContent>
							...
							<S.BarPlayerBlock>
								<S.BarPlayer>
									<TrackBarPanel handleRepeat={handleRepeat} repeat={repeat} />
									<TrackBarPlayer />
								</S.BarPlayer>
								<TrackBarVolume volume={volume} setVolume={setVolume} />
							</S.BarPlayerBlock>
						</S.BarContent>
					</S.Bar>
				</S.BarContainer>
